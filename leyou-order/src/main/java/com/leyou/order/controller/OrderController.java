...
public class OrderController {
    ...
    public ResponseEntity<Order> queryOrderById(@PathVariable(value = "id") Long id) {
     ...
     * @param page   当前页
     * @param rows   每页大小
     * @param status 订单状态：1未付款，2已付款未发货，3已发货未确认，4已确认未评价，5交易关闭，6交易成功，已评价
     * @return
     */
    @GetMapping("/list")
    ...
    @ApiResponses({
            ...
            @ApiResponse(code = 404, message = "没有查询到数据"),
